...
具体产品能力和官网来源可继续查阅已有调研：[《B2B CRM 全球代表产品与移动端体验调研》](../02-参考资料/B2B-CRM全球代表产品与移动端体验调研.md)。
...
| 商业关系阶段 | 是否已有成交关系               | 潜在客户、本年新客户、老客户 | 由成交事实和冷启动历史事实派生           |
...
- [PRD](./PRD.md) 规定用户、规则和验收结果；
- [架构决策与实施蓝图](./重构架构决策与实施蓝图.md) 规定对象、状态、事务和数据边界；
- [交互设计](./交互设计打磨.md) 规定用户如何看见和完成这些业务；
